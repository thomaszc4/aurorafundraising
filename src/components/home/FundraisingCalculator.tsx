    ...
    <div className="container-wide">
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
          See How Much <span className="text-gradient-teal">More You Could Raise</span>
        </h2>
        <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          Stop settling for pennies on the dollar. See the difference high-value products make.
        </p>
      </div>
          ...
          <CardContent className="p-8">
                ...
                return <div key={fundraiser.name} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className={`text-lg font-bold ${isAurora ? 'text-2xl text-secondary' : 'text-foreground'}`}>
            ...
            <div className="p-6 rounded-xl bg-gradient-to-r from-secondary/10 to-secondary/5 border border-secondary/20 mb-8">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <Button variant="default" size="lg" asChild className="shadow-lg shadow-secondary/20">
                  <Link to="/contact">
                    Start Earning More
