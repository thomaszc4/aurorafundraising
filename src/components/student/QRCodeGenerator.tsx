  ...
  return (
    <div className="glass-card p-6 rounded-2xl border border-white/5">
      ...
      <div className="space-y-6">
        ...
        {/* URL Display */}
        <div className="bg-background/50 border border-white/10 rounded-lg p-3 flex items-center gap-2">
          <input
            type="text"
            value={url}
            readOnly
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button onClick={handleDownload} variant="outline" className="gap-2 border-white/10 hover:bg-white/5">
            <Download className="h-4 w-4" />
            Download
          </Button>
          <Button onClick={handleShare} className="gap-2 shadow-glow hover:shadow-glow-lg transition-all">
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
          <h4 className="font-medium text-sm mb-2 text-foreground">Tips for Door-to-Door</h4>
